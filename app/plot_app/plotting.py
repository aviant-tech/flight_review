...
class DataPlot2D(DataPlot):
    ...
    def __init__(self, ulog, config, data_name, x_axis_label=None,
        ...
        super().__init__(ulog, config, data_name,
...
class DataPlotSpec(DataPlot):
    ...
    def __init__(self, ulog, config, data_name, x_axis_label=None,
        ...
        super().__init__(ulog, config, data_name, x_axis_label=x_axis_label,
...
class DataPlotFFT(DataPlot):
    ...
    def __init__(self, ulog, config, data_name,
        ...
        super().__init__(ulog, config, data_name, x_axis_label='Hz',
