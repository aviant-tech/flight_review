...
def generate_plots(ulog, px4_ulog, db_data, vehicle_data, link_to_3d_page,
    ...
    if any(elem.name == 'vehicle_air_data' or elem.name == 'vehicle_magnetometer' for elem in ulog.data_list):
    ...
    for topic in ulog.data_list:
        ...
        if topic.name == 'tecs_status':
            true_airspeed_sp_fieldname = 'airspeed_sp' \
                    if any(field.field_name == 'airspeed_sp' for field in topic.field_data) \
                    else 'true_airspeed_sp'
